                                    ...
                                    <tr>
                                        ...
                                        <td width="70%" align="right">
                                            <a style="width:148px;" type="button" class="btn btn-dark btn-sm"
                                                ...
                                                Data</font></a>
                                            <a href="../cetak/laporan_data_petugas.php" target="_blank" style="width:148px;" type="button" class="btn btn-success btn-sm">Cetak</a>
                                        </td>
                                    </tr>
                                </table>
                            </form>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="text-center">
                                    <button type="button" class="btn btn-warning btn-sm" data-nip="<?= $data['nip'] ?>"
                                        data-nama="<?= $data['nama'] ?>" data-jk="<?= $data['jk'] ?>"
                                        data-jabatan="<?= $data['jabatan'] ?>" data-toggle="modal"
                                        data-target="#edit_data">Edit</button>
                                    | <button class="btn btn-sm btn-danger" data-nip="<?= $data['nip'] ?>"
                                        data-nama="<?= $data['nama'] ?>" data-toggle="modal"
                                        data-target="#hapus_data">Hapus</button>
                                </td>
                            </tr>
                        </tbody>
                        <?php } ?>
